...
def guardar_cambio_route():
    ...
    campos = ['fecha_inicio','fecha_termino','supervisor_cliente','supervisor_metso','cliente','chancadora',
        ...
        'lubri_lineas_estado', 'lubri_lineas_obs',
